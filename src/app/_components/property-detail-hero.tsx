...
export function PropertyDetailHero({
  ...
  return (
    <section className="relative -mx-4 overflow-hidden border-b border-zinc-100 bg-gradient-to-br from-white via-[#fafbfc] to-muted-blue-tint/40 shadow-elevated sm:-mx-8 sm:rounded-3xl sm:border sm:border-zinc-100 lg:-mx-12 xl:-mx-20">
      <div
